...
class Database private constructor(
    ...
    override fun toString(): String =
        "ExposedJdbcDatabase[${hashCode()}]($resolvedVendor${config.explicitDialect?.let { ", dialect=$it" } ?: ""})"
    ...
    override val supportsMultipleResultSets by lazy(LazyThreadSafetyMode.NONE) {
